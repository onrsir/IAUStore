...
import CategoryData from '../../admin/Components/Category/CategoryData';
import ImageData from '../../admin/Components/Image/ImageData';
import UserData from '../../admin/Components/User/UserData';
import ColorData from '../../admin/Components/Color/ColorData';
import BrandData from '../../admin/Components/Brand/BrandData';
import AdressData from '../../admin/Components/Adress/AdressData';
import SizeData from '../../admin/Components/Size/SizeData';
import ProductData from '../../admin/Components/Product/ProductData';
import CommentData from '../../admin/Components/Comment/CommentData';
