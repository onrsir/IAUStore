...
import { getAddressByUserId, createAdress, getAllAdress, updateAdress, getByAdressId, deleteAdress } from '../../admin/Components/apiCall'
...
class userAdress extends Component {
    ...
    getAllAdressForTable() {
        getAddressByUserId(this.props.userId).then(response => {
            this.setState({
...
export default connect(mapStateToProps)(userAdress);
